        ...
        /*     ATENÇÃO O ULTIMO ID DO PT É ESS ---> */     { id: 'lp16', category: 'Língua Portuguesa', text: '🔥 QUENTE - Correspondência oficial (conforme Manual de Redação da Presidência da República).' },
                  ...
                  *//*
                  ...
                  /*
                    ...
                    { id: 'ti3', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Governança e valor público: Eficiência operacional.' },
                    { id: 'ti4', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Governança e valor público: Transparência administrativa.' },
                    { id: 'ti5', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Governança e valor público: Inovação no setor público.' },
                    { id: 'ti6', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Governança e valor público: Governança e gestão de TI no Setor Público.' },
                    { id: 'ti7', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Princípios: Confidencialidade, Integridade, Disponibilidade.' },
                    { id: 'ti8', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Proteção de dados: LGPD aplicada ao setor público.' },
                    { id: 'ti9', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Planejamento de projetos: Planejamento e coordenação de projetos de TI.' },
                    { id: 'ti10', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Metodologias e ferramentas: PMBOK e ferramentas de gestão de TI.' },
                    { id: 'ti11', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Modelos de desenvolvimento: Metodologias ágeis (Scrum, Kanban).' },
                    { id: 'ti12', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI DevOps: Integração contínua (CI), Entrega contínua (CD).' },
                    { id: 'ti13', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DI Atendimento institucional de TI: Suporte aos órgãos da Câmara.' },
                    { id: 'ti14', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Levantamento e análise: Levantamento de requisitos, Análise de necessidades.' },
                    { id: 'ti15', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Planejamento e Desenvolvimento de Sistemas de Informação: Levantamento de requisitos e análise de necessidades.' },
                    { id: 'ti16', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Planejamento e Desenvolvimento de Sistemas de Informação: Planejamento de sistemas e desenvolvimento orientado a processos.' },
                    { id: 'ti17', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Planejamento e Desenvolvimento de Sistemas de Informação: Especificação de funcionalidades, arquitetura e ferramentas.' },
                    { id: 'ti18', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Planejamento e Desenvolvimento de Sistemas de Informação: Documentação técnica e controle de versão.' },
                    { id: 'ti19', category: 'Tecnologia da Informação', text: '🟡 MORNO - Arquitetura e especificação: Arquitetura de sistemas.' },
                    { id: 'ti20', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Ciclo de vida: SDLC (ciclo de vida de sistemas).' },
                    { id: 'ti21', category: 'Tecnologia da Informação', text: '🟡 MORNO - Qualidade de software: Garantia de qualidade (QA).' },
                    { id: 'ti22', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Garantia de qualidade e testes de software.' },
                    { id: 'ti23', category: 'Tecnologia da Informação', text: '🟡 MORNO - Princípios da segurança: confidencialidade, integridade e disponibilidade.' },
                    { id: 'ti24', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Segurança da Informação e Proteção de Dados : Gestão de acessos e controle de permissões.' },
                    { id: 'ti25', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Segurança da Informação e Proteção de Dados : Backups, logs e auditorias.' },
                    { id: 'ti26', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Manutenção: Manutenção corretiva, preventiva, evolutiva.' },
                    { id: 'ti27', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Monitoramento: Monitoramento de desempenho, Análise de logs.' },
                    { id: 'ti28', category: 'Tecnologia da Informação', text: '🟡 MORNO - Auditoria e rastreabilidade: Logs, Auditorias, Backups.' },
                    { id: 'ti29', category: 'Tecnologia da Informação', text: '🟡 MORNO - Segurança da Informação e Proteção de Dados : Backups, logs e auditorias.' },
                    { id: 'ti30', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Suporte técnico: Nível 1 (help desk), Nível 2 (suporte especializado).' },
                    { id: 'ti31', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Suporte técnico: Manual de sistemas e help desk.' },
                    { id: 'ti32', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Relacionamento: Atendimento aos setores e Orientação proativa.' },
                    { id: 'ti33', category: 'Tecnologia da Informação', text: '🟡 DI MORNO - Viabilidade: Estudos de viabilidade, Modernização de infraestrutura.' },
                    { id: 'ti34', category: 'Tecnologia da Informação', text: '🟡 MORNO - DI Comunicação estratégica: Apresentação de soluções tecnológicas e Apoio a parlamentares.' },
                    ...
                    { id: 'ti39', category: 'Tecnologia da Informação', text: '❄️ FRIO - DI Implantação: Implantação progressiva, Adaptação e treinamento de usuários.' },
                    { id: 'ti40', category: 'Tecnologia da Informação', text: '❄️ FRIO - Monitoramento: Monitoramento de desempenho e Análise de logs.' },
                    { id: 'ti41', category: 'Tecnologia da Informação', text: '❄️ FRIO - DI Otimização: Otimização de desempenho, Usabilidade de sistemas.' },
                    { id: 'ti42', category: 'Tecnologia da Informação', text: '❄️ FRIO - DI Capacitação: Treinamento de usuários internos.' },
