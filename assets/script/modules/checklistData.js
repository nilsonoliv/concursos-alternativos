        ...
        /*     ATENÇÃO O ULTIMO ID DO PT É ESS ---> */     { id: 'lp16', category: 'Língua Portuguesa', text: '🔥 QUENTE - Correspondência oficial (conforme Manual de Redação da Presidência da República).' },
                  ...
                  *//*
                  ...
                  /*  { id: 'esp13', category: 'Legislação Específica', text: '❄️ FRIO - Resolução COFECI nº 315/1991 (Pena pecuniária).' },
                    ...
                    { id: 'ti1', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Papel estratégico da TI no setor público: Função da TI no Poder Legislativo.' },
                    { id: 'ti2', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Papel estratégico da TI no setor público: TI como suporte à gestão pública.' },
                    { id: 'ti3', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança e valor público: Eficiência operacional.' },
                    { id: 'ti4', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança e valor público: Transparência administrativa.' },
                    { id: 'ti5', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança e valor público: Inovação no setor público.' },
                    { id: 'ti6', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança e valor público: Governança e gestão de TI no Setor Público.' },
                    { id: 'ti7', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Princípios: Confidencialidade, Integridade, Disponibilidade.' },
                    ...
                    { id: 'ti11', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Modelos de desenvolvimento: Metodologias ágeis (Scrum, Kanban).' },
                    { id: 'ti12', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DevOps: Integração contínua (CI), Entrega contínua (CD).' },
                    { id: 'ti13', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Atendimento institucional de TI: Suporte aos órgãos da Câmara.' },
                    ...
                    { id: 'ti24', category: 'Tecnologia da Informação', text: '🟡 MORNO - Segurança da Informação e Proteção de Dados : Gestão de acessos e controle de permissões.' },
                    { id: 'ti25', category: 'Tecnologia da Informação', text: '🟡 MORNO - Segurança da Informação e Proteção de Dados : Backups, logs e auditorias.' },
                    ...
                    //Geografia
                    { id: 'geo1', category: 'Geografia', text: '🔥 QUENTE - DI Pesquisa tecnológica: Pesquisa aplicada à modernização legislativa digital.' },
                    { id: 'geo2', category: 'Geografia', text: '🟡 MORNO - DI Pesquisa tecnológica: Pesquisa aplicada à modernização legislativa digital.' },
                    { id: 'geo3', category: 'Geografia', text: '❄️ FRIO - DI Pesquisa tecnológica: Pesquisa aplicada à modernização legislativa digital.' }
