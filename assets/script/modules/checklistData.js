...
export const state = {
                ...
                checklistData: [
                    ...
                    { id: 'ti1', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Papel estratégico da TI: Função da TI no Poder Legislativo, TI como suporte à gestão pública.' },
                    { id: 'ti2', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança e valor público: Inovação no setor público, Transparência administrativa  Eficiência operacional, Governança e gestão de TI.' },
                    { id: 'ti3', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Princípios: Confidencialidade, Integridade, Disponibilidade.' },
                    { id: 'ti4', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Proteção de dados: LGPD aplicada ao setor público.' },
                    { id: 'ti5', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Planejamento de projetos: Planejamento e coordenação.' },
                    { id: 'ti6', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Metodologias e ferramentas: PMBOK.' },
                    { id: 'ti7', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Modelos de desenvolvimento: Metodologias ágeis (Scrum, Kanban).' },
                    { id: 'ti8', category: 'Tecnologia da Informação', text: '🔥 QUENTE - DevOps: Integração contínua (CI), Entrega contínua (CD).' },
                    { id: 'ti9', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Atendimento institucional: Suporte aos órgãos da Câmara.' },
                    { id: 'ti10', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Modernização institucional: Projetos de transformação digital, e-Câmara.' },
                    { id: 'ti11', category: 'Tecnologia da Informação', text: '🟡 MORNO - Levantamento e análise: Levantamento de requisitos, Análise de necessidades.' },
                    { id: 'ti12', category: 'Tecnologia da Informação', text: '🟡 MORNO - Planejamento de sistemas: Desenvolvimento orientado a processos.' },
                    { id: 'ti13', category: 'Tecnologia da Informação', text: '🟡 MORNO - Arquitetura e especificação: Arquitetura de sistemas.' },
                    { id: 'ti14', category: 'Tecnologia da Informação', text: '🟡 MORNO - Ciclo de vida: SDLC (ciclo de vida de sistemas).' },
                    { id: 'ti15', category: 'Tecnologia da Informação', text: '🟡 MORNO - Qualidade de software: Garantia de qualidade (QA).' },
                    { id: 'ti16', category: 'Tecnologia da Informação', text: '🟡 MORNO - Testes de software.' },
                    { id: 'ti17', category: 'Tecnologia da Informação', text: '🟡 MORNO - Manutenção: Manutenção corretiva, preventiva, evolutiva.' },
                    { id: 'ti18', category: 'Tecnologia da Informação', text: '🟡 MORNO - Monitoramento: Monitoramento de desempenho, Análise de logs.' },
                    { id: 'ti19', category: 'Tecnologia da Informação', text: '🟡 MORNO - Controle de acesso: Gestão de acessos, Permissões e autenticação.' },
                    { id: 'ti20', category: 'Tecnologia da Informação', text: '🟡 MORNO - Auditoria e rastreabilidade: Logs, Auditorias, Backups.' },
                    { id: 'ti21', category: 'Tecnologia da Informação', text: '🟡 MORNO - Suporte técnico: Nível 1 (help desk), Nível 2 (suporte especializado).' },
                    { id: 'ti22', category: 'Tecnologia da Informação', text: '🟡 MORNO - Relacionamento: Atendimento aos setores e Orientação proativa.' },
                    { id: 'ti23', category: 'Tecnologia da Informação', text: '🟡 MORNO - Viabilidade: Estudos de viabilidade, Modernização de infraestrutura.' },
                    { id: 'ti24', category: 'Tecnologia da Informação', text: '🟡 MORNO - Comunicação estratégica: Apresentação de soluções tecnológicas e Apoio a parlamentares.' },
                    { id: 'ti25', category: 'Tecnologia da Informação', text: '❄️ FRIO - Planejamento de sistemas: Modelagem de sistemas.' },
                    { id: 'ti26', category: 'Tecnologia da Informação', text: '❄️ FRIO - Arquitetura e especificação: Especificação de funcionalidades, Ferramentas de desenvolvimento.' },
                    { id: 'ti27', category: 'Tecnologia da Informação', text: '❄️ FRIO - Documentação: Documentação técnica, Controle de versão.' },
                    { id: 'ti28', category: 'Tecnologia da Informação', text: '❄️ FRIO - Modelos de desenvolvimento: Metodologias tradicionais (Cascata).' },
                    { id: 'ti29', category: 'Tecnologia da Informação', text: '❄️ FRIO - Implantação: Implantação progressiva, Adaptação e treinamento de usuários.' },
                    { id: 'ti30', category: 'Tecnologia da Informação', text: '❄️ FRIO - Monitoramento: Monitoramento de desempenho e Análise de logs.' },
                    { id: 'ti31', category: 'Tecnologia da Informação', text: '❄️ FRIO - Otimização: Otimização de desempenho, Usabilidade de sistemas.' },
                    { id: 'ti32', category: 'Tecnologia da Informação', text: '❄️ FRIO - Capacitação: Treinamento de usuários internos.' },
                    { id: 'ti33', category: 'Tecnologia da Informação', text: '❄️ FRIO - Documentação de uso: Manuais de sistemas, Base de conhecimento.' },
                    { id: 'ti34', category: 'Tecnologia da Informação', text: '❄️ FRIO - Metodologias e ferramentas: MS Project, Trello, Jira.' },
                    { id: 'ti35', category: 'Tecnologia da Informação', text: '❄️ FRIO - Pesquisa tecnológica: Pesquisa aplicada, Inovação no legislativo digital.' },
