...
export const state = {
        ...
        /*     ATENÇÃO O ULTIMO ID DO PT É ESS ---> */     { id: 'lp16', category: 'Língua Portuguesa', text: '🔥 QUENTE - Correspondência oficial (conforme Manual de Redação da Presidência da República).' },
                  ...
                  // C. Esp Formosa
                    ...
                    { id: 'cef1', category: 'C. Esp Formosa', text: '🔥 QUENTE  - Noções de saneamento básico: abastecimento de água, esgotamento sanitário, resíduos sólidos e controle de vetores.' },
                    { id: 'cef1', category: 'C. Esp Formosa', text: '🔥 QUENTE  - Procedimento administrativo de fiscalização sanitária municipal: notificação, auto de infração e devido processo legal, no âmbito das atribuições administrativas do cargo.' },
                    { id: 'cef1', category: 'C. Esp Formosa', text: '🔥 QUENTE  - Boas práticas de higiene e segurança sanitária em estabelecimentos comerciais e de alimentos.' },
                    { id: 'cef1', category: 'C. Esp Formosa', text: '🔥 QUENTE  - Noções de educação em saúde e comunicação com a comunidade.' },
                    { id: 'cef1', category: 'C. Esp Formosa', text: '🔥 QUENTE  - Ética no serviço público.' },
                    { id: 'cef1', category: 'C. Esp Formosa', text: '❄️ FRIO  - Noções de saúde pública, epidemiologia e saneamento.' },
                    { id: 'cef2', category: 'C. Esp Formosa', text: '❄️ FRIO  - Vigilância em saúde sanitária.' },
                    { id: 'cef3', category: 'C. Esp Formosa', text: '❄️ FRIO  - Controle de zoonoses.' },
                    { id: 'cef4', category: 'C. Esp Formosa', text: '❄️ FRIO  - Vigilância sanitária e Ambiental.' },
                    { id: 'cef5', category: 'C. Esp Formosa', text: '❄️ FRIO  - Combate a doenças, doenças epidêmicas.' },
                    { id: 'cef6', category: 'C. Esp Formosa', text: '❄️ FRIO  - Controle de poluição da água.' },
                    { id: 'cef7', category: 'C. Esp Formosa', text: '❄️ FRIO  - Sistemas de esgotos sanitários.' },
                    { id: 'cef8', category: 'C. Esp Formosa', text: '❄️ FRIO  - Qualidade da água.' },
                    { id: 'cef9', category: 'C. Esp Formosa', text: '❄️ FRIO  - Tratamento de água de abastecimento.' },
                    { id: 'cef10', category: 'C. Esp Formosa', text: '❄️ FRIO  - Tratamento de águas residuais.' },
                    { id: 'cef11', category: 'C. Esp Formosa', text: '❄️ FRIO  - Resíduos sólidos e limpeza pública.' },
                    { id: 'cef12', category: 'C. Esp Formosa', text: '❄️ FRIO  - Educação ambiental.' },
