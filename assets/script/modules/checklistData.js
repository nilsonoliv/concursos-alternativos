        ...
        /*     ATENÇÃO O ULTIMO ID DO PT É ESS ---> */     { id: 'lp16', category: 'Língua Portuguesa', text: '🔥 QUENTE - Correspondência oficial (conforme Manual de Redação da Presidência da República).' },
                  ...
                  *//*
                  ...
                  /*  { id: 'esp13', category: 'Legislação Específica', text: '❄️ FRIO - Resolução COFECI nº 315/1991 (Pena pecuniária).' },
                    ...
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Projetos: Melhores práticas estabelecidas pelo Project Management Institute e no PMBOK,como os conceitos de projetos, programas e portfólios, ciclo de vida dos projetos, e .' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Projetos: Melhores práticas estabelecidas pelo Project Management Institute e no PMBOK,  e suas áreas de conhecimento escopo, prazo, custo, qualidade, riscos, comunicação e aquisições.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Técnicas de gestão de riscos e monitoramento de projetos.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Segurança: políticas de segurança da informação.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Segurança: gestão de riscos.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Segurança: controles de acesso.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Segurança: criptografia básica.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Segurança: segurança em redes e aplicações.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Segurança: gestão de incidentes.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Segurança: continuidade de negócios e recuperação de desastres.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Boas práticas estabelecidas por normas como a ISO/IEC 27001.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Diretrizes do NIST.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança: Conhecimentos sobre alinhamento estratégico de TI.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança: gestão de serviços e acordos de nível de serviço (SLA).' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Governança: gestão de incidentes, problemas e mudanças, bem como melhoria contínua de processos.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Frameworks amplamente utilizados como o COBIT e o ITIL.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - Gestão de portfólio de sistemas e transformação digital.' },
                    { id: 'ti45', category: 'Tecnologia da Informação', text: '🔥 QUENTE - .' },
